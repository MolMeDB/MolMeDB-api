...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table($tableNames['permissions'])->updateOrInsert(
            [
                'name' => PermissionEnums::SSH_CREDENTIALS_MANAGE->value,
                'guard_name' => 'web',
            ],
            [
                'description' => PermissionEnums::SSH_CREDENTIALS_MANAGE->description(),
                'updated_at' => now(),
                'created_at' => now(),
            ],
        );
        ...
        $permission = DB::table($tableNames['permissions'])
            ->where('name', PermissionEnums::SSH_CREDENTIALS_MANAGE->value)
