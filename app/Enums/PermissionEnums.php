...
enum PermissionEnums: string
{
    ...
    public function description(): string
    {
        return match ($this) {
            ...
            static::DATASET_EDIT => 'Can edit datasets',
            ...
            static::MEMBRANE_METHOD_EDIT => 'Can edit membranes, methods, publications and protein targets',
