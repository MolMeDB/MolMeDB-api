...
class PredictionResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'enum_state' => $this->effectiveStateLabel(),
            'is_paused' => $this->isRemotePaused(),
            'step' => $this->step,
            ...
            'remote_status' => $this->effectiveRemoteStatus(),
            'remote_status_raw' => $this->remote_status,
            'remote_paused_at' => $this->remote_paused_at?->format('Y/m/d H:i:s'),
            'remote_pause_reason' => $this->remote_pause_reason,
            'enum_remote_status' => $this->effectiveRemoteStatusLabel(),
            'remote_current_step' => $this->remote_current_step,
            'remote_heartbeat_at' => $this->isRemotePaused()
                ? null
                : $this->remote_heartbeat_at?->format('Y/m/d H:i:s'),
