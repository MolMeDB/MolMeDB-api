...
trait HasRemoteConformers
{
    ...
    public static function getCosmoFolderName(Prediction $prediction)
    {
    ...
    public static function getLocalCosmoFolderPath(Prediction $prediction)
    {
    ...
    public static function getLocalCosmoFilePath(Prediction $prediction)
    {
        return $prediction->predictionStructure->id
            .'/'
            .$prediction::$enum_method_shorts[$prediction->method_type]
    ...
    public function hasCosmoResults(Prediction $prediction)
    {
        if (! $this->base_path) {
            return null;
        }
    ...
    public function saveCosmoResult(Prediction $prediction)
    {
        if (! $this->base_path) {
            return null;
        }
